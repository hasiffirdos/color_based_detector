...
def main(training_data, test_data,vector_size=12):
    training_feature_vector = []  # training feature vector
    test_feature_vector = []  # test feature vector
    loadDataset(training_data, test_data, training_feature_vector, test_feature_vector,_vector_size=vector_size)
